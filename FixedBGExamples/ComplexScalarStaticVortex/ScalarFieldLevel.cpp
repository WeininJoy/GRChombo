...
void ScalarFieldLevel::initialData()
{
    ...
    ComplexStaticVortexBG static_vor(m_p.vortex_params, m_dx); // just calculates chi
    InitialConditions<ComplexStaticVortexBG> set_phi(
...
void ScalarFieldLevel::prePlotLevel() {
    ...
    ComplexScalarCirculation<ScalarFieldWithPotential, ComplexStaticVortexBG>
