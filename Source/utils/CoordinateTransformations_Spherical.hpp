...
#ifndef COORDINATETRANSFORMATIONS_SPHERICAL_HPP_
#define COORDINATETRANSFORMATIONS_SPHERICAL_HPP_
...
namespace CoordinateTransformations_Spherical
{
...
#endif /* COORDINATETRANSFORMATIONS_SPHERICAL_HPP_ */
